...
Level2.prototype.preload = function () {
	...
	this.load.pack('Level2', 'assets/pack.json');
...
Level2.prototype.create = function () {
	...
	_player.weapons = []; // spool through array of weapons
...
Level2.prototype.beforeCreate = function() {
	...
	// size of world
	this.world.resize(2200, 1800); // expand first value to lengthen
...
Level2.prototype.update = function() {
	...
	if(this.fPlayer.fruits > 10){
		...
		// this.fPlayer.weapons.push(weapon);
		// console.log("You have a "+weapon.name);
		this.fPlayer.fruits = 0;
	}
	...
	console.log("you are at: "+this.fPlayer.coffeeCount);
 ...
 *            coffee
 */
Level2.prototype.playerVsCoffee = function(player, coffee) {
...
playerGetsWeapon = function(player, weapon) {
	...
	console.log("You have got :"+weapon.name);
};
